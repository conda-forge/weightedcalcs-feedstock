About weightedcalcs-feedstock
=============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/weightedcalcs-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/jsvine/weightedcalcs

Documentation: https://github.com/jsvine/weightedcalcs
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5411&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/weightedcalcs-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `weightedcalcs` can be installed with `conda`:
...
```
mamba install weightedcalcs
```

It is possible to list all of the versions of `weightedcalcs` available on your platform with `conda`:
...
```
mamba search weightedcalcs --channel conda-forge
```
...
mamba repoquery search weightedcalcs --channel conda-forge

# List packages depending on `weightedcalcs`:
mamba repoquery whoneeds weightedcalcs --channel conda-forge

# List dependencies of `weightedcalcs`:
mamba repoquery depends weightedcalcs --channel conda-forge
```
